...
<form method="post" action="GestionPanier.php" class="form-horizontal" role="form">
	...
	{	
	   ...
	   else
	   {
	      for ($i=0 ;$i < $nbArticles ; $i++)
	      {
	         ...
	         $requete = "SELECT * FROM produits WHERE id=".$_SESSION['panier']['libelleProduit'][$i]."";
	         ...
	         echo "<td><a href=\"".htmlspecialchars("GestionPanier.php?action=suppression&l=".rawurlencode($_SESSION['panier']['libelleProduit'][$i]))."\">Supprimer la ligne</a></td>";
	         echo "</tr>";
