	...
	<div class="container-fluid">	
		...
		<section>
			<ul>
				...
				$reponse = $bdd->prepare("SELECT * FROM recette WHERE idCategorie=2 ORDER BY noteGlobale DESC");
				$reponse->execute();
				...
				<div class="row-fluid">					
					<div class="cadre_liste_recettes">								
						...
						<p class="nomRecette">
							<a href="platchaudrecette.php?idRecette=<?php echo $data['idRecette']; ?>" >
