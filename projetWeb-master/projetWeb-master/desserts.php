 ...
 <body>  
	<div class="container-fluid">	
		...
		<header id="header" class="hero-unit">
			...
			<i><a href="platschauds.php">Aller consulter les plats chauds</a></i>
		</header>
		...
		<section>
			<ul>
				...
				$reponse = $bdd->prepare("SELECT * FROM recette WHERE idCategorie=3 ORDER BY noteGlobale DESC");
				$reponse->execute();
				...
				<div class="row-fluid">					
					<div class="cadre_liste_recettes">								
						...
						<p class="nomRecette">
							<a href="dessertrecette.php?idRecette=<?php echo $data['idRecette']; ?>" >
